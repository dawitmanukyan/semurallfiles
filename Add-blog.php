      ...
      <main id="main-container">
        ...
        <div class="content content-boxed">
         ...
         style="padding: 15px;"> '; ?>
            ...
            <div class="mb-4">
                <label class="form-label" for="example-file-input">Բլոգի Երկրորդ նկարը (Ընտրեք նկարը համակարգչից, ավելացնելու համար)</label>
                <input class="form-control" type="file" name="file2" id="example-file-input">
            </div>

            <div class="mb-4">
                <label class="form-label" for="example-file-input">Բլոգի Երրորդ նկարը (Ընտրեք նկարը համակարգչից, ավելացնելու համար)</label>
                <input class="form-control" type="file" name="file3" id="example-file-input">
            </div>

            <div class="mb-4">
                <label class="form-label" for="example-file-input">Բլոգի Չորրորդ նկարը (Ընտրեք նկարը համակարգչից, ավելացնելու համար)</label>
                <input class="form-control" type="file" name="file4" id="example-file-input">
            </div>

            <div class="mb-4">
                <label class="form-label" for="example-file-input">Բլոգի Հինգերրորդ նկարը (Ընտրեք նկարը համակարգչից, ավելացնելու համար)</label>
